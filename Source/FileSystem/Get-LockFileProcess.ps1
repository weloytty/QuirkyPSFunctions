...
.DESCRIPTION
    ...
    Original version of this function was grabbed from 
    https://raw.githubusercontent.com/pldmgg/misc-powershell/master/MyFunctions/PowerShellCore_Compatible/Get-FileLockProcess.ps1

...
@{
    ...
    'ConvertTo-Base26', 'Get-ProcessBitness', 'Get-EnumValues', 'Get-UrlEncodedString',
    'Get-UrlDecodedString'
    ...
    'ief', 'whereis', 'gmv', 'cal', 'hex2dec', 'dec2hex', 'gpb', 'urlencode', 'urldecode'
